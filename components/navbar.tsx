            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-primary hover:bg-secondary transition-all duration-300">
                  ...
                  {t("locale.currentShort")}
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
                <DropdownMenuItem onClick={() => switchLocale("zh")} className="hover:bg-secondary hover:text-primary">{t("locale.zh")}</DropdownMenuItem>
                <DropdownMenuItem onClick={() => switchLocale("en")} className="hover:bg-secondary hover:text-primary">{t("locale.en")}</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
                ...
                <div className="flex items-center space-x-2 px-3 py-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-secondary border-primary/30">
                      <DropdownMenuItem onClick={() => switchLocale("zh")} className="text-foreground hover:bg-primary/20 hover:text-primary">{t("locale.zh")}</DropdownMenuItem>
                      <DropdownMenuItem onClick={() => switchLocale("en")} className="text-foreground hover:bg-primary/20 hover:text-primary">{t("locale.en")}</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                  {mounted && (
